...
using CodeYu.AspNetBoilerplateDemo.Sessions;
using Shouldly;
using Xunit;

namespace CodeYu.AspNetBoilerplateDemo.Tests.Sessions
{
    public class SessionAppService_Tests : AspNetBoilerplateDemoTestBase
    {
