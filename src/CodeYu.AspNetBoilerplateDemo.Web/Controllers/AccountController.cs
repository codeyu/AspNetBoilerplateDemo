...
using CodeYu.AspNetBoilerplateDemo.Web.Authentication;
using CodeYu.AspNetBoilerplateDemo.Web.Models.Account;

namespace CodeYu.AspNetBoilerplateDemo.Web.Controllers
{
    public class AccountController : AspNetBoilerplateDemoControllerBase
    {
